...
@section('content')
        ...
        <div>
          {!! Form::open(['route' => 'egresados.index', 'method' => 'GET']) !!}
            {!! Form::text('query', $query, array(
                'class' => 'bg-gray-200 focus:bg-white mt-1 px-2 leading-tight appearance-none rounded h-10 w-100 border-2 border-teal-200',
                'placeholder' => ''
            )) !!}
    ...
    <div class="mx-16 mt-4 mb-8 flex">
        <div class="w-1/6 mr-1">
            ...
            <a href="/#" class="text-gray-700 px-2 py-2 rounded relative block hover:bg-teal-200 hover:text-gray-900 font-medium no-underline">
