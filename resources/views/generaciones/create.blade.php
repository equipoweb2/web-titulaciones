...
@section('content')
    ...
    <p class="opacity-75 uppercase tracking-wide font-bold text-lg text-center mx-16 my-4"><i class="fa fa-file-invoice-dollar"></i> Agregar generación</p>

    <div>
        <div class="p-4 rounded-b w-full flex justify-center">
          <div class="w-1/3 bg-gray-100 p-4 shadow-md">
            {!! Form::open(['route' => 'generaciones.store', 'files' => true]) !!}
                <div>
